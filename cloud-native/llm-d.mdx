...
description: "llm-d is a Kubernetes-native distributed inference framework that lets you serve LLM models across a cluster."
---
...
<Steps>
<Step title="Step 1: Set up Gateway API CRDs">
...
<Step title="Step 2: Deploy GIE-compatible Gateway">
...
<Step title="Step 3: Prepare Kubernetes Secret">
...
<Step title="Step 4: Download the Target LLM Model">
...
<Step title="Step 5: Deploy llm-d">
...
<Step title="Step 6: Expose the service with an HTTPRoute">
