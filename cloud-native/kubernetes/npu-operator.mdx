...
description: "The Furiosa NPU Operator is a Kubernetes operator that automates the deployment and management of FuriosaAI NPU devices within a Kubernetes cluster."
---
