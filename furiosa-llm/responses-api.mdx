---
title: "Responses API"
description: "Furiosa-LLM implements the OpenResponses specification, a multi-provider, interoperable LLM interface."
---

import OnlineResponsesBasic from '/snippets/examples/online_responses_basic.mdx';
import OnlineResponsesMultiTurn from '/snippets/examples/online_responses_multi_turn.mdx';
import OnlineResponsesStreaming from '/snippets/examples/online_responses_streaming.mdx';
...
<OnlineResponsesBasic />

Streaming:

<OnlineResponsesStreaming />
