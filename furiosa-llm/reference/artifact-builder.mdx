...
{/* TODO: furiosa_llm.artifact.Artifact is not re-exported by the furiosa_llm.artifact package (__init__.py); class extracted from furiosa_llm/artifact/types/next_gen.py */}

```python
class furiosa_llm.artifact.Artifact(
    *,
