---
title: "Llama 3.3"
description: "Llama 3.3 is Meta's instruction-tuned, auto-regressive dense transformer optimized for multilingual dialogue, instruction following, and tool usage, with quality competitive with much larger models."
---
...
For the smaller 8B model see [Llama 3.1](/furiosa-llm/models/llama-3-1).
