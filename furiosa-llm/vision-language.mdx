...
description: "Furiosa-LLM serves Vision-Language (VL) models that accept text and images through the OpenAI-compatible Chat Completions API."
---

import OpenaiCurlVl from '/snippets/examples/openai_curl_vl.mdx';
import OnlineVlChatCompletion from '/snippets/examples/online_vl_chat_completion.mdx';
